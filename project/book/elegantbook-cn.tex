...
\extrainfo{年轻的时候,我们总是会将自己的创作冲动误解为创作才能。——钱钟书《围城》}
...
\begin{figure}[htb]
	\subfigure[]
	{\includegraphics[height = 0.2\textheight]{figure/figure/mmexport1609434428516.JPG}}	
	\subfigure[]
	{\includegraphics[height = 0.2\textheight]{figure/figure/shot.jpg}}
...
\begin{figure}[h!]
	\subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/kiss.jpg}}
	\subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/insect.jpg}}
	\subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/mmexport1610637190141.JPG}}
	\subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/mmexport1610636900168.JPG}}
	\subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/mirror.jpg}}
...
\begin{figure}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/wx_camera_1610979352802.JPG}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/wx_camera_1610979372817.JPG}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/mmexport1610982229882.JPG}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/mmexport1610982236263.JPG}}
...
\begin{figure}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/heisi.JPG}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/mmexport1611071099713.JPG}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/stand.jpg}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/mmexport1611071048401.JPG}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/lay.jpg}}
...
\begin{figure}
    \includegraphics[height=0.2\textheight]{figure/figure/qipao.jpg}
...
\end{figure}
\begin{figure}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/fengmian.jpg}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/interview.jpg}}
...
\end{figure}
\begin{figure}
    \subfigure[]{\includegraphics[height=0.14\textheight]{figure/figure/shengwudao1.jpg}}
    \subfigure[]{\includegraphics[height=0.14\textheight]{figure/figure/shengwudao2.jpg}}
    \subfigure[]{\includegraphics[height=0.14\textheight]{figure/figure/shengwudao3.jpg}}
...
\end{figure}
\begin{figure}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/tianqiao1.JPG}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/tianqiao2.JPG}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/tianqiao3.JPG}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/tianqiao4.JPG}}
    \subfigure[]{\includegraphics[height=0.2\textheight]{figure/figure/tianqiao5.jpg}}
...
\end{figure}
\begin{figure}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/angry.JPG}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/shougong.JPG}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/necklace.JPG}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/zhongxinhu.JPG}}
...
\end{figure}
\begin{figure}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/wodedabian1.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/wodedabian2.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/wodedabian3.jpg}}
...
\begin{figure}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/vaccine1.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/vaccine2.jpg}}
...
\end{figure}
\begin{figure}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/yibaodabian1.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/yibaodabian2.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/yibaodabian3.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/yibaodabian4.jpg}}
    \caption{这一天是怡宝答辩的日子，怡宝把头发梳成大人模样，化了美美的妆，还穿上了高跟鞋，很漂亮！}
\end{figure}
\begin{figure}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/paiwanxia1.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/paiwanxia2.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/paiwanxia3.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/paiwanxia4.jpg}}
...
\end{figure}
\begin{figure}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/biyezhao1.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/biyezhao2.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/biyezhao3.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/biyezhao4.jpg}}
    \caption{转眼就到了毕业的日子，我跟怡宝在学校拍毕业照。（a）（b）（c）于6月23日拍摄于中山
    大学东校区图书馆。（d）于6月29日拍摄于中山大学南校区北门牌坊。}
\end{figure}
\begin{figure}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/bansushe1.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/bansushe2.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/bansushe3.jpg}}
    \caption{7月2号，我和怡宝去南校拿证明材料，办完正事后吃了南校的松涛园。（a）为饭后摘莲
    花的时候怡宝拍摄的。(b)拍摄于南校返东校的校巴上。（c）拍摄于晚上从明德园搬到格致园的路上。}
\end{figure}

\begin{figure}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/pati1.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/pati2.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/pati3.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/pati4.jpg}}
    \caption{7月6号，怡宝请客去琶醍喝酒。拍摄于洛奇先生牛仔餐吧。果酒还挺好喝的，吃的也
    还行，主要是照片拍的漂亮。}
\end{figure}
\begin{figure}[h!]
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/huizhou1.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/huizhou2.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/huizhou3.jpg}}
    \subfigure[]{\includegraphics[height=0.15\textheight]{figure/figure/huizhou4.jpg}}

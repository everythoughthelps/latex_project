...
\begin{figure}
	...
	\caption{Diagram of \textit{single point perspective} drawing:
	...
	\label[]{perspective}
\end{figure}
So in this phase, we utilize vanishing point for better 
...
blank position in the area:
	...
	\mathcal{L}_{blank} =\sqrt{\partial_x^2 (m \odot I) + \partial_y^2 (m \odot I) }
 	\end{align}
Besides, we designed white loss to make the 'graffiti' more 
likely to be sticked 
in the white area:
\begin{align}

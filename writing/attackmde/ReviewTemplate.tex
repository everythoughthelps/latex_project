...
Actually, the connection lines, which converge to vanishing
points, will look shorter than it completely 
...
consisits of two optimazation sub-terms:
	\begin{align}
		\label[]{blank}
...
on areas with low texture complexity:
	\begin{align}
		\label[]{smooth}
		\mathcal{L}_{smooth} = 
		-\sqrt{\partial_x^2 (m \odot I) + \partial_y^2 (m \odot I)}
 	\end{align}
where $ $ denotes.

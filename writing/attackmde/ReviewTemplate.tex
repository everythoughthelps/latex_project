...
the target pixel. Bilinear interpolation mechanism is proved 
...
The location problem is settled by optimizing $\mathbf{T}_\Theta$,
next we address altering the appearance of the patch.
In this phase, we utilize vanishing points for better 
visual quality. We first detect straight lines in the attacked 
scene with Hough transform, then we compute the vanishing 

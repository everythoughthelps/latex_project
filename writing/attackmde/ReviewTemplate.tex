...
\begin{table*}
    ...
    \begin{tabular}{c|c|c|c|c|c|c|c|c}  
		\toprule
      \multicolumn{2}{c|}{}&RMSE$\downarrow$ &MAE$\downarrow$
	  &Absrel$\downarrow$ &$\delta_1\uparrow$ 
	  &$\delta_2\uparrow$&$\delta_3\uparrow$&Runtime \\  % 表格中的内容，用&分开，\\表示下一行
      \midrule
      %& & & \\[-6pt]  %可以避免文字偏上 
      ...
      \multirow{3}{*}{Ours}&$L_1$&0.643&0.464&0.175&0.738&0.920&0.973&0.772  \\
      					&$L_2$&0.641&0.461&\textbf{0.177}&0.739&0.921&0.973&0.781  \\
      	&Huber&\textbf{0.648}&\textbf{0.466}&0.176&\textbf{0.737}&\textbf{0.919}&\textbf{0.972}&0.772  \\
		\bottomrule
    \end{tabular}
  \end{table*}
